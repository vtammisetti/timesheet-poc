...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("S4TimeEntriesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheS4TimeEntriesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheS4TimeEntriesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheS4TimeEntriesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheS4TimeEntriesListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheS4TimeEntriesListGenerated.onTable().iPressRow(0);
            Then.onTheS4TimeEntriesObjectPageGenerated.iSeeThisPage();
