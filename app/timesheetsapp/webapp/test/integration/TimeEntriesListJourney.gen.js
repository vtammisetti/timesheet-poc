...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("TimeEntriesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheTimeEntriesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheTimeEntriesListGenerated.onFilterBar().iChangeSearchField("Search Term");
